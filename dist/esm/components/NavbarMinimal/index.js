...
export function EgeriaNavbar(props) {
    ...
    return (_jsxs(Navbar, Object.assign({ p: "md", width: { base: 80, sm: 80, lg: 80 } }, { children: [_jsx(Navbar.Section, Object.assign({ grow: true }, { children: _jsx(Group, { children: links }) })), _jsxs(Navbar.Section, { children: [_jsx(Group, { children: _jsx(NavbarLink, { icon: UserCircle, label: "Profile", href: "/profile" }) }), _jsx(Group, { children: _jsx(NavbarLink, { icon: InfoCircle, label: "About", href: "/about" }) }), _jsx(Group, { children: _jsx(NavbarLink, { icon: Logout, label: "Logout", onClick: () => handleLogout() }) })] })] })));
}
